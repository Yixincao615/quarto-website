...
The test statistic measures how far our estimate is from 0 in standard deviation units. The p-value tells us how likely it is to observe a result this extreme if the null hypothesis were true.

If the p-value is small (typically below 0.05), we reject the null hypothesis. In this case, the result suggests that the difference in sign-up rates is statistically significant, providing evidence that one CTA performs better than the other.
