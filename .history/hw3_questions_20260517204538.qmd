...
The peak of the log-likelihood curve represents the value of $\lambda$ that best fits the observed patent counts. Visually, the maximizing value appears close to the sample mean of the data.
