...
This result makes intuitive sense because the Poisson distribution uses a single parameter λ to represent both the mean and the variance of the distribution.
