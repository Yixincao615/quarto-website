...
# fix merge type mismatch
design["item"] = pd.to_numeric(design["item"], errors="coerce").astype(int)
labels["item"] = pd.to_numeric(labels["item"], errors="coerce").astype(int)

data = design.merge(labels, on="item", how="left")
