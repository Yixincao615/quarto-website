...
# Rename design columns only if needed
...
# Clean labels file robustly
labels = labels.copy()

# If labels has original columns
if "Item #" in labels.columns:
    labels = labels.rename(columns={"Item #": "item_id"})

# If labels has original class-name column
if "item" in labels.columns and "item_label" not in labels.columns:
    labels = labels.rename(columns={"item": "item_label"})
