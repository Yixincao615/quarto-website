...
Age squared was included because the relationship between firm age and patent production is unlikely to be perfectly linear. One region indicator was omitted to avoid perfect multicollinearity with the intercept.

The Poisson regression model was estimated using Maximum Likelihood Estimation (MLE). I first constructed the design matrix \(X\), then fit the model using Python’s `statsmodels` package.
