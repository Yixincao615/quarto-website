...
Blueprinty customers appear to have higher patent counts on average than non-customers. However, this raw comparison does not prove that the software caused the difference, because customers and non-customers may differ in other important ways.
...
The regional distribution is not identical across customer groups. This suggests that region should be included as a control variable in the regression model.
...
Firm age also differs across groups. This matters because older firms may have more experience, resources, and established research pipelines, which could increase patent output even without Blueprinty’s software. For this reason, the regression model controls for age, age squared, and region.
